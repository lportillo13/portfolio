...
const Header: FC = () => {
  ...
  return (
    <header
      className={`transition-all duration-300 ${isScrolled ? "h-24" : "h-40"} fixed flex text-white left-0 top-0 z-50 w-full backdrop-blur-[12px]`}
    >
      <nav className="container mx-auto flex justify-between items-center">
        ...
        <ul
          className={`fixed top-0 left-0 w-full h-screen bg-black bg-opacity-80 flex flex-col items-center justify-center space-y-8 transition-all duration-300 ${

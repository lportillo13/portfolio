  ...
  return (
    ...
    <section id="home" className="h-screen flex items-center justify-center fade-in">
        <div className="relative flex w-full flex-col h-full md:h-screen p-10 md:p-0 items-center justify-center md:justify-end overflow-hidden bg-background md:shadow-xl">
            ...
            <h1 className="pointer-events-none whitespace-pre-wrap bg-gradient-to-br dark:from-white from-white from-30% dark:to-white/40 to-black/40 bg-clip-text text-center text-5xl md:text-7xl font-semibold leading-none text-transparent dark:from-white dark:to-slate-900/10">
